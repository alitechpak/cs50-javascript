...
1. **Python** (a widely-used programming language we’ll use to make our sites more dynamic)
1. **Django** (a popular web framework we’ll use for the backend of our sites)
1. **SQL, Models, and Migrations** (a language used for storing and retrieving data, and Django-specific methods that make it easier to interact with SQL databases)
1. **JavaScript** (a programming language used to make websites faster and more interactive)
1. **User Interfaces** (methods used to make a website as easy to use as possible)
1. **Testing, CI, CD** (learning about different methods used to make sure updates to web pages proceed smoothly)
1. **Scalability and Security** (making sure our websites can be accessed by many users at once, and that they are safe from malicious intent)
...
![Hello Page](cs50.web.2020_files/lecture00/hello0.png)
...
![DOM](cs50.web.2020_files/lecture00/dom.png)
...
![Elements](cs50.web.2020_files/lecture00/elements.png)
...
![form](cs50.web.2020_files/lecture00/form.png)
...
<html>
```
![blue heading](cs50.web.2020_files/lecture00/style0.png)
...
![blue everywhere](cs50.web.2020_files/lecture00/style1.png)
...
![table bad](cs50.web.2020_files/lecture00/table0.png)
...
![table good](cs50.web.2020_files/lecture00/table1.png)
...
![selectors](cs50.web.2020_files/lecture00/selectors.png)
...
![list selector](cs50.web.2020_files/lecture00/selectors0.png)
...
![link selectors](cs50.web.2020_files/lecture00/selectors2.png)
...
<html>
```
![buttons](cs50.web.2020_files/lecture00/buttons.gif)
...
![screen size](cs50.web.2020_files/lecture00/responsive0.gif)
...
![flexbox](cs50.web.2020_files/lecture00/flexbox.gif)
...
![grid](cs50.web.2020_files/lecture00/grid.gif)
...
![columns](cs50.web.2020_files/lecture00/cols1.gif)
...
![wrap columns](cs50.web.2020_files/lecture00/cols2.gif)
...
![inheritance](cs50.web.2020_files/lecture00/inherit.png)
